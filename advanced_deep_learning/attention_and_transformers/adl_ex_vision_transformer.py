...
class VisTrans(nn.Module):
    def __init__(self,
        ...
        # split into 16x16 patches and calculate embeddings
        self.conv1 = nn.Conv2d(3, embed_dim, (16, 16), (16, 16), 0)

        self.embedding_dropout = nn.Dropout(embedding_dropout)
        self.layer = TransformerEncoderLayer(d_model=embed_dim,
                                             nhead=n_heads,
        ...
        self.pooling = nn.AvgPool2d([256, 1])
        self.dropout = nn.Dropout(dropout)
        self.fc = nn.Linear(embed_dim, output_dim)

        self.pos_encoding = PositionalEncoding(embed_dim, 256)
...
def main():
    ...
    model = VisTrans(embed_dim=128, hidden_dim=128, output_dim=37, n_layers=2, embedding_dropout=0.0, n_heads=8, dropout=0.0)
