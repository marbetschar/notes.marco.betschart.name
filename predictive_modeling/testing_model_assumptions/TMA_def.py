...
def tma_plots(model, n_samp=1000):
    ...
    plot_residuals(ax1, y_hat, res, title='Tukey-Anscombe plot - Residuals vs Fitted')
    ax4 = fig.add_subplot(3, 3, 4)
    plot_residuals(ax4, y_hat, res, n_samp=n_samp, title='Tukey-Anscombe plot - Residuals vs Fitted')

    # Second subplot Q-Q Plot
    ax2 = fig.add_subplot(3, 3, 2)
    plot_QQ(ax2, res_standard, title='Normal plot or Q-Q plot')
    ax5 = fig.add_subplot(3, 3, 5)
    plot_QQ(ax5, res_standard, n_samp=n_samp, title='Normal plot or Q-Q plot')

    # Third subplot: Scale location
    ax3 = fig.add_subplot(3, 3, 3)
    plot_scale_loc(ax3, y_hat, res_stand_sqrt, x_lab='Fitted values')
    ax6 = fig.add_subplot(3, 3, 6)
    plot_scale_loc(ax6, y_hat, res_stand_sqrt, n_samp=n_samp, x_lab='Fitted values')
    ...
    plot_cooks(ax7, res_inf_leverage, res_standard, n_pred=1,
